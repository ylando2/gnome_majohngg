...
public class Mahjongg : Gtk.Application
{
    ...
    protected override void startup ()
    {
        ...
        game_view.auto_play=settings.get_boolean("autoplay");
    ...
    private void toggle_auto_play_cb (Gtk.ToggleButton widget)
    {
        bool on_or_off=widget.get_active();
        settings.set_boolean ("autoplay",on_or_off);
        game_view.auto_play=on_or_off;
        if (game_view.game!=null) {
            game_view.game.auto_move();
        }
    }
    ...
    private void preferences_cb ()
    {
        ...
        var auto_play_button = new Gtk.CheckButton.with_mnemonic (_("_Auto play"));
        auto_play_button.show ();
        auto_play_button.toggled.connect (toggle_auto_play_cb);
        auto_play_button.set_active (settings.get_boolean ("autoplay"));
        grid.attach (auto_play_button, 0, 4, 1, 1);
